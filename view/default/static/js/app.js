			...
			jQuery(window).resize(function() {
				...
				window.afterResizeApp = setTimeout(function() {
					...
					**/
					window.width = jQuery(window).width();
					// Mobile & desktop menu
          //jQuery("#moreMenuBtn").removeClass('active');
					// Aside
					_asideFix();
 ...
 **************************************************************** **/
	function _aside() {
		...
		// Mobile Button
  jQuery("#moreMenuBtn").bind("click", function (e) {
			e.preventDefault();
  ...
  jQuery('#aside ul.nav li a').bind("click", function (e) {
    var _t = jQuery(this);
    var _href = _t.attr('href');
    if (_href == '#') {
      e.preventDefault();
    }
    var find_li = jQuery(this).closest('li');
    if (!find_li.hasClass('always-open') && (!find_li.hasClass('menu-open') || $(e.target).hasClass('toggler'))) {
 ...
 **************************************************************** **/
	function _panels() {
      ...
      panel.find("table.dataTable").each(function () {
        jQuery(this).DataTable().draw('page');
      });
