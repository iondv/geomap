...
(function () {
  ...
  Map.FilterField.prototype = {
    ...
    init: function () {
      if (this.data.eagerLoading instanceof Array) {
        this.eagerLoading = this.data.eagerLoading.map(function (item) {
          return this.data.filteredClass+':'+this.data.eagerLoading;
        }.bind(this)).join(',');
      }
    },
    ...
    filter: function (item) {
      if (this.value === null || item.__class !== this.data.filteredClass) {
        return true;
      }
    ...
    getEagerLoadingData: function () {
      return this.eagerLoading && this.value !== null ? this.eagerLoading : null;
    }
  };
})();
