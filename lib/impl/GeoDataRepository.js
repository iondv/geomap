...
function GeoDataRepository(options) {
  ...
  this.bindCoord = function (item, type, coords) {
    if (!options.dataSource) {
      return Promise.reject(new Error('Data source of the coordinate dictionary is not configured.'));
    }
  ...
  this._getLayerData = function (area, query, opts) {
    return new Promise(function (resolve, reject) {
      if (typeof query.getRestUrl === 'function') {
        ...
        // TODO Take into account the nested levels of data - MAYBE FUNCTIONAL DOES NOT NEED
        ...
        if (typeof query.getLocationAttribute === 'function') {
          ...
          if (!options.dataSource) {
            return reject(new Error('Data source of the coordinate dictionary is not configured.'));
          }
          let locationFilter = {
            [F.AND]: [
          ...
          reject(new Error('Invalid layer description object.'));
        }
      }
    });
  };
